...
<div id="main-menu">
	<div class="title-bar">
		<div class="main-tabs">
			...
			<a class="users-tab" onclick="showTabMain('.users-tab'); loadTitle('<%=lutil.get("users.title", lang)%>');"> <%=lutil.get("users", lang)%>
			</a>	 
			<a class="groups-tab" onclick="showTabMain('.groups-tab'); loadTitle('<%=lutil.get("groups.title",lang)%>');"> <%=lutil.get("groups", lang)%>
			</a>	
			<a class="oldseasons-tab" onclick="showTabMain('.oldseasons-tab'); loadTitle('<%=lutil.get("oldseasons.title", lang)%>');"> <%=lutil.get("season.oldseasons", lang)%>
			</a>
		</div>
