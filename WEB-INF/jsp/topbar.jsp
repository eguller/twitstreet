	...
	<div id="top_left_div">
		...
		<div id="twitstreet-header-container">
			<table class="datatbl2">
				<tbody>
					<tr>
						<td style="width: 45px;"><a href="/"> <img height="45"
								width="45" alt="twitstreet.com" title="twitstreet.com"
								src="/images/twitstreet_logo_50.png"> </a></td>
						<td style="vertical-align: top">
							<div id="twitstreet-header" style="float: left;">
								<a id="home" style="font-size: 22px; vertical-align: top;"
									href="/">TwitStreet </a> <br>
			...
			<tr>
				...
				<td width="33%">
					<div align="center">
						...
						<h1>
							<b><%=lutil.get("season", lang)%> <%=seasonMgr.getCurrentSeason().getId()%></b>
						</h1>

						<h1>
							<b><%=seasonMgr.getCurrentSeason().localizedSeasonTime(lang)%></b>
						</h1>

					</div></td>
				<td width="33%" style="vertical-align: bottom">
					<div id="twitstreet-languages"
						style="font-size: 6px; margin-bottom: 7px; float: right; clear: both; text-align: right">


						<select onchange="loadLanguage($(this).val())"
							style="font-size: 11px;">

							<%
								ArrayList<String> languages = LocalizationUtil.getInstance()
										.getLanguages();
							...
							%>
							<option
								<%=(selectLang.equalsIgnoreCase(lang)) ? "selected=\"selected\""
						: ""%>
								value="<%=selectLang%>"><%=lutil.getLanguageLongName(selectLang)%></option>
