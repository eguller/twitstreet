	...
	<div id="balance" class="main-div">
		...
		<table class="right_aligned datatbl">
			...
			<tr>
				...
				<td></td>
				<td style="padding-left: 2px; padding-right: 2px; text-align: center;">&nbsp;</td>
				<td colspan="2" id="total_trend" style="text-align: left"><%=user == null || user.getProfit()==0? "" : Util.getNumberFormatted(user.getProfit(), true, false, true, true, false, true)%></td>
				<td/>
			</tr>
			</tr>
		</table>
