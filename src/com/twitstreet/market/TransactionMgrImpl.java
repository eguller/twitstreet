...
public class TransactionMgrImpl implements TransactionMgr {
	enum Error {
		ConcurrentUserTransaction("Concurrent Transaction Error"), NoStocksAvailable(
				"All followers sold out.");
	...
	@Override
	public Object buy(final long buyer, final long stock, int amount)
			throws SQLException {
		Object result = null;
